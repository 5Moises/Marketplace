...
<section>
    ...
    <details>
        ...
        <form action="BoletaCorreoServlet" method="POST">
            ...
            <input type="datetime-local" name="dtp_fechahora"/>
            <input type="text" name="txt_nombrerepartidor"/>
            <input type="hidden" name="txt_codempresa" value="<%= CodEmpresa%>"/>
            <input type="submit" name="btn_enviar" value="Enviar Comprobante por correo"/>
        </form>  
