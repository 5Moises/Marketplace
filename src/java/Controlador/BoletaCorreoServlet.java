...
public class BoletaCorreoServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String NombreRepartidor = request.getParameter("txt_nombrerepartidor").trim();
        ...
        try {
            if (!NombreRepartidor.equals("")) {
                ...
                cuadrodialogo.CuadroMensaje(request, response, "Empresa.jsp?CodEmpresa=" + CodEmpresa + "&Seccion=Pedidos", "Correo enviado", "Éxito");
            } else {
                cuadrodialogo.CuadroMensaje(request, response, "Empresa.jsp?CodEmpresa=" + CodEmpresa + "&Seccion=Pedidos", "Especifique el nombre del repartidor", "Aviso");
            }
        } catch (Exception Ex) {
